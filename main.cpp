...
static void generate_proposals(std::vector<GridAndStride> grid_strides, const ncnn::Mat& pred, float prob_threshold, std::vector<Object>& objects)
{
	...
	std::cout<<pred.w<<"  "<<pred.h<<" "<<pred.c<<std::endl;
...
static int detect_yolov8(const cv::Mat& bgr, std::vector<Object>& objects)
{
    ...
    yolov8.load_param("/home/sugon/zhangshen/yolov8_tracking/weights/yolov8n.param");
    yolov8.load_model("/home/sugon/zhangshen/yolov8_tracking/weights/yolov8n.bin");
...
void test_bytetrack(cv::Mat& frame, std::vector<Object>& results,BYTETracker& tracker)
{
    std::vector<Object> objects;


    for (Object dr : results)
    {

        if(dr.label == 0) //person
        {
...
int main(int argc, char** argv)
{
    ...
    // bytetrack
    int fps=20;
	BYTETracker bytetracker(m, fps, 30);
